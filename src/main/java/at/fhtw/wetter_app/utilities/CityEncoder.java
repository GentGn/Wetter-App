...
public class CityEncoder {
     ...
     * @return Eine Liste der kodierten Städtenamen.
     *         Falls ein Fehler auftritt, werden nur die erfolgreich kodierten Städtenamen in der Liste enthalten sein.
     */
    public static List<String> encodeCityNames(List<String> cities) {
        ...
        for (String city : cities) {
            try {
                ...
                e.printStackTrace();  // Ausnahmebehandlung bei nicht unterstützter Kodierung
            }
        }
     ...
     * @return Der kodierte Städtename im URL-Encoding-Format oder null, wenn ein Fehler auftritt.
     */
    public static String encodeCityName(String city) {
        try {
            ...
            e.printStackTrace();  // Ausnahmebehandlung bei nicht unterstützter Kodierung
            return null;          // Gibt null zurück, wenn die Kodierung fehlschlägt
        }
    }
}
